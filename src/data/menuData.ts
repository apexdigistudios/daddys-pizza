...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'lf1', name: 'Cheesy Bacon Loaded Fries', description: 'Fries smothered in nacho cheese, crispy bacon, and sour cream.', price: 38, image: '/images/cheesy-bacon-loaded-fries.png', tag: 'Fan Favorite' },
      { id: 'lf2', name: 'BBQ Pulled Pork Fries', description: 'Fries topped with pulled pork, BBQ sauce, coleslaw, and pickles.', price: 42, image: '/images/bbq-pulled-pork-fries.png' },
      { id: 'lf3', name: 'Spicy Chicken Loaded Fries', description: 'Fries with spicy chicken, jalapeños, cheese sauce, and hot sauce.', price: 40, image: '/images/spicy-chicken-loaded-fries.png' },
